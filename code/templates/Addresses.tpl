...
<div class="row dashboard user_panel">
  ...
  <div class="dash"></div>
      ...
      <div class="row mblue_box1">
        ...
        <div class="ship_add">{$shipping.address1} {if $shipping.address2 !=''},  {$shipping.address2} {/if},{$shipping.city}   </div>
     ...
     <!-- <h4 class="shead">Billing Address</h4>-->
      ...
      <div class="row mblue_box1" style="background:none;">
        ...
        <div class="ship_add">{$billing.address1} {if $billing.address2 !=''} ,  {$billing.address2}{/if} , {$billing.city} </div>
