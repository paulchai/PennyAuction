...
<div class="col-md-6">
 <form action="{$config.url}/search" id="user_search" name="user_search" method="get"  enctype="multipart/form-data"><div class="input-group">   
          <input type="text" class="form-control srbt3" value="{$search_search}"  name="search" id="search"  maxlength="300">
...
<div class="col-md-2 srtr3">{if $loged.userid > 0} <a href="{$config.url}/dashboard/" title="{$loged.first_name}">{$loged.first_name}</a> / <a href="{$config.url}/login/logout/" title="Logout">{$_phrase.logout}</a> {else} <a data-toggle="modal" data-target="#myModal" href="javascript:void(0);">{$_phrase.register} / </a></span> <span> <a data-toggle="modal"  data-target="#login" href="javascript:void(0);">{$_phrase.log_in}</a> {/if}</div>
</div>
<div class="row">
...
<nav class="navbar navbar-default hifiy ftmdpro" style="z-index:100">
  <div class="container-fluid">
    ...
    <div class="navbar-header mg42min">
      <button type="button" class="navbar-toggle collapsed bttny2 " data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
    ...
    <div class="collapse navbar-collapse ftmdpro" id="bs-example-navbar-collapse-1">
     ...
     <li class="l9ie">|</li>
       ...
       <li class="l9ie">|</li>
        ...
        <li class="l9ie">|</li>
        <li class="hty3"><a href="{$config.url}/winner" title="Winners"> {$_phrase.winner}{$_phrase.s}</a></li>
         <li class="l9ie">|</li>
