...
<div class="row dashboard user_panel">
  ...
  <div class="col-md-9" style="width:65%">
      <div class="dash"></div>
      <div class="abutop">Profile Settings</div>
    ...
    <form action="/profile_settings/update/" method="post" accept-charset="utf-8" enctype="multipart/form-data"  data-parsley-validate>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <button type="button" class="btn save_btn" style="margin-left:20px;padding:0;width:100px !important;height:25px !important" onclick="triggerfile()">Upload</button>
        </div>
      </div>
      <div class="row">
