        ...
        <form action="/profile_settings/update/" id="profile_settings" method="post" accept-charset="utf-8"
            ...
            <div class="row hrht">
                <div class="col-xs-12 col-sm-3 col-md-3 pull-right">
                    ...
                    <button type="button" class="ep_change_btn" onclick="triggerfile()">Change</button>
            ...
            <div class="row">
                <div class="form-group">
                    <label for="about_me" class="col-xs-12 col-sm-6 col-md-4">About *:</label>
            ...
            <div class="row">
                <div class="form-group">
                    <label for="address_line1" class="col-xs-12 col-sm-6 col-md-4">Address Line 1*:</label>
            ...
            <div class="row">
                <div class="form-group">
                    <label for="address_line2" class="col-xs-12 col-sm-6 col-md-4">Address Line 2*:</label>
            ...
            <div class="row">
                <div class="form-group">
                    <label for="zipcode" class="col-xs-12 col-sm-6 col-md-4">Zipcode*:</label>
            ...
            <div class="row">
                <div class="form-group">
                    <label for="phone" class="col-xs-12 col-sm-6 col-md-4">Phone Number*:</label>
            ...
            <div class="row">
                <div class="form-group">
                    <label for="Categories" class="col-xs-12 col-sm-6 col-md-4">Select Categories :</label>
