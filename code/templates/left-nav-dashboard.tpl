<div class="white_box" id="horiz-menu">
					...
					<div class="wb_lbl"><a href="{$config.url}/dashboard"><span class="img_up"><img src="{$config.url}/images/db1.png" alt="" /></span>{$_phrase.dashboard}<i class="fa fa-chevron-circle-right"></i></a></div>
					 ...
					 <!-- paul remove <div class="wb_lbl"><a href="{$config.url}/package/"><span class="img_up"><img src="{$config.url}/images/db5.png" alt="" /></span>{$_phrase.buypackage}<i class="fa fa-chevron-circle-right"></i></a></div> -->
                   ...
                   <!-- paul remove {if $seated}  <div class="wb_lbl disabled"><a href=" {$config.url}/dashboard/seated"><span class="img_up"><img src="{$config.url}/images/seat.png" alt="" /></span>{$_phrase.seated_auction}<i class="fa fa-chevron-circle-right"></i></a></div>  {/if}
