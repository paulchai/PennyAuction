   ...
   <form method="POST" enctype="multipart/form-data" class="admin_form" data-parsley-validate name="add-product" id="add-product" action="/admincp/products/save">   
    ...
    <div class="form-group">
      ...
      <div class="pro_image pro_image_{$val2.id}">
         ...
         <a href="javascript:$('.pro_image_{$val2.id}').remove();"> Delete </a>
       </div>
      {/foreach}
      <div>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="description" id="product_info" data-parsley-group="block1" required  data-parsley-maxlength="500" data-parsley-length="[100, 500]" value="" onkeyup="limitlengths(this, 500,'product_info_label')">{$projects.description}
        </textarea>
      </div>
      <div class="form-group">
        <label>Buynow price</label>
        <input name="bprice" id="bprice" class="form-control floatpoint" data-parsley-group="block1" required maxlength="20"  placeholder="0.00"  value="{$projects.bprice}" type="text">
      </div>
      <div class="form-group">
        <label>Market price</label>
        <input name="mprice" id="mprice"  class="form-control floatpoint"  data-parsley-group="block1" required maxlength="20"  placeholder="0.00"  value="{$projects.mprice}" type="text">
      </div>
      <div class="form-group">
