...
<div class="main_container admin_wrapper">
  ...
  <div class="right_admin_panel clearfix">
        ...
        <div class="aw_thead">Manage Newsletters</div>
        <div class="aw_thead1">
            <div>Home</div>
		...
		<div class="pull-right">
			<button class="btn btn-primary">
             ...
             <div class="row btbox">
                ...
                <div class="col-md-4">Subscriber IP</div>
            ...
            <div class="col-md-1"><input type="checkbox" /></div>
                ...
                <div class="col-md-4">lincolnthings@gmail.com</div>
                <div class="col-md-4">50.110.69.100</div>
