...
exports.searcherViaUrl = function (req, mysql, callback) {
    ...
    //data['page'] = '';
    //console.log(data);
    q.all([products.searchProducts(mysql, q, data, req)]).then(function (results) {
        //console.log(results[0][0]);
...
exports.projects = function (mysql, callback) {
    ...
    q.all([products.homeProducts(mysql, q, 1), products.futureProducts(mysql, q, 2), products.seatedProducts(mysql, q)]).then(function (results) {
        data1 = results[0][0];
        data2 = results[1][0];
        data3 = results[2][0];
        ...
        odata['seated_project'] = req_data3;
        //console.log(odata);
        callback(odata);
