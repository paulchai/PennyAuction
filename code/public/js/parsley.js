...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    email:        "Email address needs to be in the format yourname@domain.com.",
  ...
  minlength:      "In order to get the best results, please enter a minimum of %s characters.",
  maxlength:      "This value is too long. It should have %s characters or less.",
  length:         "In order to get the best results, please enter a minimum of %s characters.",
